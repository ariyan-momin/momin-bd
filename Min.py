...
\033[1;32m┃   \033[1;32mCREATED BY\33[0;m   :  \033[1;32mMOMIN.CYBER            ┃
┃   \033[1;32mFACEBOK      : \033[1;32m md momin khan              ┃
┃   \033[1;32mGITHUB       :  \033[1;32mhacker-momin       ┃
...
a=requests.get("https://github.com/hacker-momin").text
b=str(a)
key1=open("/storage/emulated/0/android8.txt",'r').read()
key2=str(key1)  
if key2 in b:
    ...
    print("Your key  : "+key2)
    print("\n\t\tContact Admin ")
    os.system('xdg-open https://www.facebook.com/profile.php?id=100075615693948//ERR0RS')
    exit()
